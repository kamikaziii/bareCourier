-- Fix bulk_recalculate_type_based_prices RPC function
-- Fixes:
-- 1. Incorrect 'base' field in breakdown for out-of-zone and time_preference
-- 2. Missing timeSpecificPrice > 0 check
-- 3. Use explicit variables instead of record to avoid ROW() issues
