...
- [x] Error logged to console on parse failure
- [x] Service worker continues running after malformed push
...
| 2026-01-26 | Fix implemented: wrapped event.data.json() in try-catch | Simple defensive coding prevents silent failures |
