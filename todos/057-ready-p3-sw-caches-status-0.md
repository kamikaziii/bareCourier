...
- [ ] CacheableResponsePlugin removed from Supabase route
- [ ] CacheableResponsePlugin removed from Mapbox route
- [ ] Supabase still uses NetworkFirst with default [0, 200]
- [ ] Mapbox uses CacheFirst with default [200] only
- [ ] Build succeeds
- [ ] Maps still load correctly
